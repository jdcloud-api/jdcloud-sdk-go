...
func NewListRiskPolicysRequest(
	...
	return &ListRiskPolicysRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/wafInstanceIds/{wafInstanceId}/risk:listRiskPolicys",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *ListRiskPolicysRequest) SetReq(req *waf.ListRiskCommonReq) {
    r.Req = req
}
