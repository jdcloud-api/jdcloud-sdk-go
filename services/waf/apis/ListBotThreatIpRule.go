...
func NewListBotThreatIpRuleRequest(
	...
	return &ListBotThreatIpRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/wafInstanceIds/{wafInstanceId}/bot:listThreatRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *ListBotThreatIpRuleRequest) SetReq(req *waf.ListBotThreatIpRuleReq) {
    r.Req = req
}
