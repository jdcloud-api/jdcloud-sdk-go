...
func NewUpdateBotUsrRuleRequest(
	...
	return &UpdateBotUsrRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/wafInstanceIds/{wafInstanceId}/bot:updateUsrRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *UpdateBotUsrRuleRequest) SetReq(req *waf.SetBotUsrRuleReq) {
    r.Req = req
}
