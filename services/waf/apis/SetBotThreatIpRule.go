...
func NewSetBotThreatIpRuleRequest(
	...
	return &SetBotThreatIpRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/wafInstanceIds/{wafInstanceId}/bot:setThreatRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *SetBotThreatIpRuleRequest) SetReq(req *waf.SetBotThreatIpRuleReq) {
    r.Req = req
}
