...
func NewListRiskEventVarsRequest(
	...
	return &ListRiskEventVarsRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/wafInstanceIds/{wafInstanceId}/risk:listRiskEventVars",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *ListRiskEventVarsRequest) SetReq(req *waf.ListRiskEventVarsReq) {
    r.Req = req
}
