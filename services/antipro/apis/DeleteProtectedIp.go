...
func NewDeleteProtectedIpRequest(
	...
	return &DeleteProtectedIpRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}:deleteProtectedIp",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
        ...
        ProtectedIpSpec: protectedIpSpec,
	}
}
...
func (r *DeleteProtectedIpRequest) SetProtectedIpSpec(protectedIpSpec *antipro.ProtectedIpSpec) {
    r.ProtectedIpSpec = protectedIpSpec
}
