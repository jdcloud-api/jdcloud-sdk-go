 ...
 * param networkConfiguration: Runtime 网络配置。 (Required)
 * param roleName: 绑定 IAM 服务角色名。 (Optional)
 * param envs: Runtime 环境变量配置，最多 50 组。 (Optional)
 * param filesystemConfiguration: Runtime 文件系统配置，最多支持配置 5 个文件系统。 (Optional)
