...
func NewDescribeTransmissionTaskAttributesRequest(
	...
	return &DescribeTransmissionTaskAttributesRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/dts/{taskId}",
			Method:  "GET",
			Header:  nil,
			Version: "v2",
		},
...
/* param taskId: DTS数据传输任务ID(Required) */
func (r *DescribeTransmissionTaskAttributesRequest) SetTaskId(taskId string) {
    r.TaskId = taskId
}
...
func (r DescribeTransmissionTaskAttributesRequest) GetRegionId() string {
    return r.RegionId
}
