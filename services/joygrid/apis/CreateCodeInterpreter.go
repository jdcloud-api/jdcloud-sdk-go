...
type CreateCodeInterpreterRequest struct {
    ...
    /*  (Optional) */
    Body *joygrid.CreateCodeInterpreterSpec `json:"body"`
}
...
func NewCreateCodeInterpreterRequestWithAllParams(
    regionId string,
    body *joygrid.CreateCodeInterpreterSpec,
) *CreateCodeInterpreterRequest {
...
/* param body: (Optional) */
func (r *CreateCodeInterpreterRequest) SetBody(body *joygrid.CreateCodeInterpreterSpec) {
    r.Body = body
}
