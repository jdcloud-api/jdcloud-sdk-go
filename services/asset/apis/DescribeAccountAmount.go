...
type DescribeAccountAmountRequest struct {
...
func NewDescribeAccountAmountRequest(
	...
	return &DescribeAccountAmountRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/assets:describeAccountAmount",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
type DescribeAccountAmountResponse struct {
    ...
    Result DescribeAccountAmountResult `json:"result"`
}

type DescribeAccountAmountResult struct {
