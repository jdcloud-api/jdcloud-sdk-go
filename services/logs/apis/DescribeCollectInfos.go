 ...
 */
func NewDescribeCollectInfosRequest(
    regionId string,
    logtopicUID string,
) *DescribeCollectInfosRequest {

	return &DescribeCollectInfosRequest{
 ...
 */
func NewDescribeCollectInfosRequestWithAllParams(
    regionId string,
    logtopicUID string,
    pageNumber *int,
    pageSize *int,
...
type DescribeCollectInfosResult struct {
