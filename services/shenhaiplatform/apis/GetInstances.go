...
func NewGetInstancesRequest(
	...
	return &GetInstancesRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/apps/{appName}/getInstances",
			Method:  "POST",
			Header:  nil,
			Version: "v2",
		},
...
func NewGetInstancesRequestWithoutParam() *GetInstancesRequest {
...
/* param regionId: 地域ID(Required) */
func (r *GetInstancesRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}
/* param appName: 应用名称(Required) */
...
/* param workspaceCode: (Optional) */
func (r *GetInstancesRequest) SetWorkspaceCode(workspaceCode string) {
    r.WorkspaceCode = &workspaceCode
}
/* param projectCode: (Optional) */
func (r *GetInstancesRequest) SetProjectCode(projectCode string) {
...
func (r GetInstancesRequest) GetRegionId() string {
    return r.RegionId
}
...
type GetInstancesResponse struct {
    ...
    Result GetInstancesResult `json:"result"`
}

type GetInstancesResult struct {
    Code string `json:"code"`
    Message string `json:"message"`
    Result shenhaiplatform.EngineBoundInstancesResp `json:"result"`
}