...
type UranusScriptSyntaxCheckRequest struct {
 ...
 */
func NewUranusScriptSyntaxCheckRequest(
    regionId string,
    appName string,
    flowCode string,
	...
	return &UranusScriptSyntaxCheckRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/apps/{appName}/uranusScriptSyntaxCheck",
			Method:  "POST",
			Header:  nil,
			Version: "v2",
		},
...
func NewUranusScriptSyntaxCheckRequestWithoutParam() *UranusScriptSyntaxCheckRequest {
...
/* param regionId: 地域ID(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}
/* param appName: 应用名称(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetAppName(appName string) {
    r.AppName = appName
}
/* param flowCode: 流程code(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetFlowCode(flowCode string) {
    r.FlowCode = flowCode
}
/* param dataSourceCode: 数据源code(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetDataSourceCode(dataSourceCode string) {
    r.DataSourceCode = dataSourceCode
}
/* param fileCode: 文件code(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetFileCode(fileCode string) {
    r.FileCode = fileCode
}
/* param fileName: 文件名称(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetFileName(fileName string) {
    r.FileName = fileName
}
/* param fileType: 文件类型 SQL,SHELL,PYTHON,PERL,R,SparkJar,StarRocks,MySQL(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetFileType(fileType string) {
    r.FileType = fileType
}
/* param content: 脚本内容(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetContent(content string) {
    r.Content = content
}
/* param execEngine: sql执行引擎 apReduce,Spark,Tez,presto,Python2,Python3,auto,StarRocks,MySQL(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetExecEngine(execEngine string) {
    r.ExecEngine = execEngine
}
/* param args: 脚本参数配置(Optional) */
func (r *UranusScriptSyntaxCheckRequest) SetArgs(args []shenhaiplatform.UranusTaskParamReq) {
    r.Args = args
}
/* param segment: sql脚本是否全部执行 是false,否true(Required) */
func (r *UranusScriptSyntaxCheckRequest) SetSegment(segment bool) {
    r.Segment = segment
}
/* param resourceName: 队列名称(Optional) */
func (r *UranusScriptSyntaxCheckRequest) SetResourceName(resourceName string) {
    r.ResourceName = &resourceName
}
/* param resourceCode: 队列code(Optional) */
func (r *UranusScriptSyntaxCheckRequest) SetResourceCode(resourceCode string) {
...
func (r UranusScriptSyntaxCheckRequest) GetRegionId() string {
    return r.RegionId
}

type UranusScriptSyntaxCheckResponse struct {
    RequestID string `json:"requestId"`
    Error core.ErrorResponse `json:"error"`
    Result UranusScriptSyntaxCheckResult `json:"result"`
}

type UranusScriptSyntaxCheckResult struct {
