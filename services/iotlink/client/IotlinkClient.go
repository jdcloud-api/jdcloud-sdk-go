...
/* NB卡有效期查询 */
func (c *IotlinkClient) QueryValidPeriodForNB(request *iotlink.QueryValidPeriodForNBRequest) (*iotlink.QueryValidPeriodForNBResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.QueryValidPeriodForNBResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 物联网卡自主限速接口 */
func (c *IotlinkClient) SpeedLimitAction(request *iotlink.SpeedLimitActionRequest) (*iotlink.SpeedLimitActionResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.SpeedLimitActionResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 物联网卡实名制信息清除 */
func (c *IotlinkClient) OrdinaryRealNameClear(request *iotlink.OrdinaryRealNameClearRequest) (*iotlink.OrdinaryRealNameClearResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.OrdinaryRealNameClearResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 在线状态和会话信息查询 */
func (c *IotlinkClient) GetOnlineStatus(request *iotlink.GetOnlineStatusRequest) (*iotlink.GetOnlineStatusResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.GetOnlineStatusResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 物联网卡日历史流量查询接口 */
func (c *IotlinkClient) QueryDayHistoryTraffic(request *iotlink.QueryDayHistoryTrafficRequest) (*iotlink.QueryDayHistoryTrafficResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.QueryDayHistoryTrafficResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 物联网卡移动实名登记接口 */
func (c *IotlinkClient) SimRealNameReg(request *iotlink.SimRealNameRegRequest) (*iotlink.SimRealNameRegResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.SimRealNameRegResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 物联网卡流量查询（时间段）查询接口 */
func (c *IotlinkClient) QueryTrafficByDate(request *iotlink.QueryTrafficByDateRequest) (*iotlink.QueryTrafficByDateResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.QueryTrafficByDateResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 机卡分离状态查询 */
func (c *IotlinkClient) CardBindStatus(request *iotlink.CardBindStatusRequest) (*iotlink.CardBindStatusResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &iotlink.CardBindStatusResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
