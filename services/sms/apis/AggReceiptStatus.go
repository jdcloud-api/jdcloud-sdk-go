...
func NewAggReceiptStatusRequest(
	...
	return &AggReceiptStatusRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/aggReceiptStatus",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
        RegionId: regionId,
        AggReceiptStatusSpec: aggReceiptStatusSpec,
	}
}
...
func (r *AggReceiptStatusRequest) SetAggReceiptStatusSpec(aggReceiptStatusSpec *sms.AggReceiptStatusSpec) {
    r.AggReceiptStatusSpec = aggReceiptStatusSpec
}
