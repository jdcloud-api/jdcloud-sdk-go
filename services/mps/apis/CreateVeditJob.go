...
type CreateVeditJobRequest struct {
    ...
    /* 剪辑合成媒资元数据  */
    MediaMetadata *mps.MediaMetadata `json:"mediaMetadata"`
 ...
 * param mediaMetadata: 剪辑合成媒资元数据 (Required)
 *
...
/* param timeline: 时间线信息(Required) */
func (r *CreateVeditJobRequest) SetTimeline(timeline *mps.Timeline) {
    r.Timeline = timeline
}
/* param mediaMetadata: 剪辑合成媒资元数据(Required) */
func (r *CreateVeditJobRequest) SetMediaMetadata(mediaMetadata *mps.MediaMetadata) {
