 ...
 * param endpoint: 通知endpoint，当前支持http://和https://, 未来会支持sms:, email:, queues: 等 (Optional)
 * param events: 触发通知的事件集合 (Optional)
 ...
 * param notifyContentFormat: 描述了向 Endpoint 推送的消息格式, JSON包含消息正文和消息属性, SIMPLIFIED消息体即用户发布的消息，不包含任何属性信息 (Optional)
 */
