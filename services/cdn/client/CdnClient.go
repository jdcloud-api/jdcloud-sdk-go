...
/* 域名限速 */
func (c *CdnClient) SpeedLimit(request *cdn.SpeedLimitRequest) (*cdn.SpeedLimitResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
...
/* 生成域名txt记录 */
func (c *CdnClient) GenerateDomainTxt(request *cdn.GenerateDomainTxtRequest) (*cdn.GenerateDomainTxtResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
...
/* 批量添加域名ip黑名单 */
func (c *CdnClient) BatchIpBlackList(request *cdn.BatchIpBlackListRequest) (*cdn.BatchIpBlackListResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &cdn.BatchIpBlackListResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* null */
func (c *CdnClient) QueryPinCanIPType(request *cdn.QueryPinCanIPTypeRequest) (*cdn.QueryPinCanIPTypeResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &cdn.QueryPinCanIPTypeResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
