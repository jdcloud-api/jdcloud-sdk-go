...
func NewUpdateStartCmdRequest(
	...
	return &UpdateStartCmdRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/app/{appId}/group/{groupId}:updateStartCmd",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param cpu: CPU核数(Optional) */
func (r *UpdateStartCmdRequest) SetCpu(cpu int) {
    r.Cpu = &cpu
}
/* param memory: 内存大小(GB)(Optional) */
func (r *UpdateStartCmdRequest) SetMemory(memory int) {
    r.Memory = &memory
}
/* param requestCpu: 请求CPU核数(Optional) */
func (r *UpdateStartCmdRequest) SetRequestCpu(requestCpu int) {
    r.RequestCpu = &requestCpu
}
/* param requestMemory: 请求内存大小(GB)(Optional) */
func (r *UpdateStartCmdRequest) SetRequestMemory(requestMemory int) {
