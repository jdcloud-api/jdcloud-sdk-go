...
func NewUpdateLifeCycleRequest(
	...
	return &UpdateLifeCycleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/app/{appId}/group/{groupId}:updateLifeCycle",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param cpu: CPU核数(Optional) */
func (r *UpdateLifeCycleRequest) SetCpu(cpu int) {
    r.Cpu = &cpu
}
/* param memory: 内存大小(GB)(Optional) */
func (r *UpdateLifeCycleRequest) SetMemory(memory int) {
    r.Memory = &memory
}
/* param requestCpu: 请求CPU核数(Optional) */
func (r *UpdateLifeCycleRequest) SetRequestCpu(requestCpu int) {
    r.RequestCpu = &requestCpu
}
/* param requestMemory: 请求内存大小(GB)(Optional) */
func (r *UpdateLifeCycleRequest) SetRequestMemory(requestMemory int) {
