 ...
 */
func NewScanPackageRequest(
    appId string,
    packageId int,
) *ScanPackageRequest {

	return &ScanPackageRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/app/{appId}/package/{packageId}:scan",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func NewScanPackageRequestWithoutParam() *ScanPackageRequest {
...
func (r ScanPackageRequest) GetRegionId() string {
    return ""
}
...
type ScanPackageResponse struct {
    ...
    Result ScanPackageResult `json:"result"`
}
