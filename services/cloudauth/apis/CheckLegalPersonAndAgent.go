...
func NewCheckLegalPersonAndAgentRequest(
	...
	return &CheckLegalPersonAndAgentRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/company:legalPersonAndAgent",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
        LegalPersonAndAgentSpec: legalPersonAndAgentSpec,
	}
}
...
func (r *CheckLegalPersonAndAgentRequest) SetLegalPersonAndAgentSpec(legalPersonAndAgentSpec *cloudauth.LegalPersonAndAgentSpec) {
    r.LegalPersonAndAgentSpec = legalPersonAndAgentSpec
}
