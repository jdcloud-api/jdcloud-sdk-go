...
func NewConfirmSaleServiceDeliveryRequest(
	...
	return &ConfirmSaleServiceDeliveryRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/confirmSaleServiceDelivery",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
        RegionId: regionId,
        ConfirmDeliveryInfo: confirmDeliveryInfo,
	}
}
...
func (r *ConfirmSaleServiceDeliveryRequest) SetConfirmDeliveryInfo(confirmDeliveryInfo *elite.ConfirmDeliveryInfo) {
    r.ConfirmDeliveryInfo = confirmDeliveryInfo
}
