...
func NewCacheDateHistogramBandwidthRequest(
	...
	return &CacheDateHistogramBandwidthRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/zones/{zone_identifier}/analytics$$cacheDateHistogramBandwidth",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param filters: (Optional) */
func (r *CacheDateHistogramBandwidthRequest) SetFilters(filters []starshield.AnalyticsReportingFilter) {
    r.Filters = filters
}
...
func (r CacheDateHistogramBandwidthRequest) GetRegionId() string {
    return ""
}
