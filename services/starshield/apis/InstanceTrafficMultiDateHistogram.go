...
func NewInstanceTrafficMultiDateHistogramRequest(
	...
	return &InstanceTrafficMultiDateHistogramRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/instances/{instanceId}/instanceTrafficMultiDateHistogram",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param since: 查询开始时间(Required) */
func (r *InstanceTrafficMultiDateHistogramRequest) SetSince(since string) {
    r.Since = since
}
/* param until: 查询结束时间(Required) */
func (r *InstanceTrafficMultiDateHistogramRequest) SetUntil(until string) {
    r.Until = until
}
...
func (r InstanceTrafficMultiDateHistogramRequest) GetRegionId() string {
    return ""
}
