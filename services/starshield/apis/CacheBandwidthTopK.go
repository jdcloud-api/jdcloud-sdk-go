...
func NewCacheBandwidthTopKRequest(
	...
	return &CacheBandwidthTopKRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/zones/{zone_identifier}/analytics$$cacheBandwidthTopK",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param filters: (Optional) */
func (r *CacheBandwidthTopKRequest) SetFilters(filters []starshield.AnalyticsReportingFilter) {
    r.Filters = filters
}
