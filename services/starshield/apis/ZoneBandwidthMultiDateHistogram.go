...
func NewZoneBandwidthMultiDateHistogramRequest(
	...
	return &ZoneBandwidthMultiDateHistogramRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/zones/{zone_identifier}/zoneBandwidthMultiDateHistogram",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param since: 开始时间(Required) */
func (r *ZoneBandwidthMultiDateHistogramRequest) SetSince(since string) {
    r.Since = since
}
/* param until: 结束时间(Required) */
func (r *ZoneBandwidthMultiDateHistogramRequest) SetUntil(until string) {
    r.Until = until
}
...
func (r ZoneBandwidthMultiDateHistogramRequest) GetRegionId() string {
    return ""
}
