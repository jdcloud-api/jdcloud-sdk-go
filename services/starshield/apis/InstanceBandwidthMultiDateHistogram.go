...
func NewInstanceBandwidthMultiDateHistogramRequest(
	...
	return &InstanceBandwidthMultiDateHistogramRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/instances/{instanceId}/instanceBandwidthMultiDateHistogram",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param since: 查询开始时间(Required) */
func (r *InstanceBandwidthMultiDateHistogramRequest) SetSince(since string) {
    r.Since = since
}
/* param until: 查询结束时间(Required) */
func (r *InstanceBandwidthMultiDateHistogramRequest) SetUntil(until string) {
    r.Until = until
}
...
func (r InstanceBandwidthMultiDateHistogramRequest) GetRegionId() string {
    return ""
}
