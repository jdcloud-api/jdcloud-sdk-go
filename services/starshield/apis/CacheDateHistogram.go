...
func NewCacheDateHistogramRequest(
	...
	return &CacheDateHistogramRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/zones/{zone_identifier}/analytics$$cacheDateHistogram",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param filters: (Optional) */
func (r *CacheDateHistogramRequest) SetFilters(filters []starshield.AnalyticsReportingFilter) {
    r.Filters = filters
}
