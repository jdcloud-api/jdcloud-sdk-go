...
type DeleteBackSourceConfigurationRequest struct {
...
func NewDeleteBackSourceConfigurationRequest(
    regionId string,
    bucketName string,
) *DeleteBackSourceConfigurationRequest {

	return &DeleteBackSourceConfigurationRequest{
...
type DeleteBackSourceConfigurationResponse struct {
    RequestID string `json:"requestId"`
    Error core.ErrorResponse `json:"error"`
    Result DeleteBackSourceConfigurationResult `json:"result"`
}
