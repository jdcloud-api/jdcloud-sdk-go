...
func NewDescribeParameterGroupParametersRequest(
	...
	return &DescribeParameterGroupParametersRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/parameterGroups/{parameterGroupId}/parameters",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
func (r DescribeParameterGroupParametersRequest) GetRegionId() string {
    return r.RegionId
}
