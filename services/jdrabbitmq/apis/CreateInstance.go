...
type CreateInstanceRequest struct {
    ...
    /* rabbitmq实例的相关配置  */
    Instance *jdrabbitmq.InstanceSpec `json:"instance"`
 ...
 * param instance: rabbitmq实例的相关配置 (Required)
 *
 * @Deprecated, not compatible when mandatory parameters changed
 */
func NewCreateInstanceRequest(
    regionId string,
    instance *jdrabbitmq.InstanceSpec,
...
/* param instance: rabbitmq实例的相关配置(Required) */
func (r *CreateInstanceRequest) SetInstance(instance *jdrabbitmq.InstanceSpec) {
    r.Instance = instance
}
/* param charge: 计费信息的相关配置，只有prepaid_by_duration和postpaid_by_duration 2种计费模式(Optional) */
