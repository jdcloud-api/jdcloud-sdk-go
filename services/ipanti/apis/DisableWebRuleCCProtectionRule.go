...
func NewDisableWebRuleCCProtectionRuleRequest(
	...
	return &DisableWebRuleCCProtectionRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:disableWebRuleCCProtectionRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r DisableWebRuleCCProtectionRuleRequest) GetRegionId() string {
    return r.RegionId
}
