...
func NewModifyAlarmConfigRequest(
	...
	return &ModifyAlarmConfigRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}:modifyAlarmConfig",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
        ...
        AlarmConfigSpec: alarmConfigSpec,
	}
}
...
func (r *ModifyAlarmConfigRequest) SetAlarmConfigSpec(alarmConfigSpec *ipanti.AlarmConfigSpec) {
    r.AlarmConfigSpec = alarmConfigSpec
}
