...
func NewModifyWebRuleJsPageToCustomRequest(
	...
	return &ModifyWebRuleJsPageToCustomRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:modifyWebRuleJsPageToCustom",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r ModifyWebRuleJsPageToCustomRequest) GetRegionId() string {
    return r.RegionId
}
