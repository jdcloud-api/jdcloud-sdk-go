...
func NewEnableBlackListRuleOfForwardRuleRequest(
	...
	return &EnableBlackListRuleOfForwardRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/forwardRules/{forwardRuleId}:enableBlackListRuleOfForwardRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r EnableBlackListRuleOfForwardRuleRequest) GetRegionId() string {
    return r.RegionId
}
