...
func NewDescribeWebRuleWhiteListUsageRequest(
	...
	return &DescribeWebRuleWhiteListUsageRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:describeWebRuleWhiteListUsage",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
func (r DescribeWebRuleWhiteListUsageRequest) GetRegionId() string {
    return r.RegionId
}
