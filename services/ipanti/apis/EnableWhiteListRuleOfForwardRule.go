...
func NewEnableWhiteListRuleOfForwardRuleRequest(
	...
	return &EnableWhiteListRuleOfForwardRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/forwardRules/{forwardRuleId}:enableWhiteListRuleOfForwardRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r EnableWhiteListRuleOfForwardRuleRequest) GetRegionId() string {
    return r.RegionId
}
