...
func NewDisableWhiteListRuleOfWebRuleRequest(
	...
	return &DisableWhiteListRuleOfWebRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}/webWhiteListRules/{webWhiteListRuleId}:disable",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r DisableWhiteListRuleOfWebRuleRequest) GetRegionId() string {
    return r.RegionId
}
