...
func NewDescribeInstanceIdByResourceIdRequest(
	...
	return &DescribeInstanceIdByResourceIdRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/describeInstanceIdByResourceId",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
func (r DescribeInstanceIdByResourceIdRequest) GetRegionId() string {
    return r.RegionId
}
