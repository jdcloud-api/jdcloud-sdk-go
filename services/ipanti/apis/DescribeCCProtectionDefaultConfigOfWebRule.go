...
func NewDescribeCCProtectionDefaultConfigOfWebRuleRequest(
	...
	return &DescribeCCProtectionDefaultConfigOfWebRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:ccProtectionDefaultConfig",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
/* param regionId: 区域 ID, 高防不区分区域, 传 cn-north-1 即可(Required) */
func (r *DescribeCCProtectionDefaultConfigOfWebRuleRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}
...
func (r DescribeCCProtectionDefaultConfigOfWebRuleRequest) GetRegionId() string {
    return r.RegionId
}
