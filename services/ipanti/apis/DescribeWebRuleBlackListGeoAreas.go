...
func NewDescribeWebRuleBlackListGeoAreasRequest(
	...
	return &DescribeWebRuleBlackListGeoAreasRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/describeWebRuleBlackListGeoAreas",
			Method:  "GET",
			Header:  nil,
			Version: "v1",
		},
...
func (r DescribeWebRuleBlackListGeoAreasRequest) GetRegionId() string {
    return r.RegionId
}
