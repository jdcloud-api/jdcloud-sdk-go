...
func NewEnableWebRuleCCProtectionRuleRequest(
	...
	return &EnableWebRuleCCProtectionRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:enableWebRuleCCProtectionRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r EnableWebRuleCCProtectionRuleRequest) GetRegionId() string {
    return r.RegionId
}
