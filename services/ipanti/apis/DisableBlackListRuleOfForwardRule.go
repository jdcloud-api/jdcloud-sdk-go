...
func NewDisableBlackListRuleOfForwardRuleRequest(
	...
	return &DisableBlackListRuleOfForwardRuleRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/instances/{instanceId}/forwardRules/{forwardRuleId}:disableBlackListRuleOfForwardRule",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
func (r DisableBlackListRuleOfForwardRuleRequest) GetRegionId() string {
    return r.RegionId
}
