...
func NewRestartInstanceRequest(
	...
	return &RestartInstanceRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/apps/{appName}/restartInstance",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param appName: 应用名称(Required) */
func (r *RestartInstanceRequest) SetAppName(appName string) {
    r.AppName = appName
}
/* param projectCode: 项目实例Code(Optional) */
func (r *RestartInstanceRequest) SetProjectCode(projectCode string) {
