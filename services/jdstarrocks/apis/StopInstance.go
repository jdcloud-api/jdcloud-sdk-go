...
func NewStopInstanceRequest(
	...
	return &StopInstanceRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/apps/{appName}/stopInstance",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param appName: 应用名称(Required) */
func (r *StopInstanceRequest) SetAppName(appName string) {
    r.AppName = appName
}
/* param projectCode: 项目实例Code(Optional) */
func (r *StopInstanceRequest) SetProjectCode(projectCode string) {
